...
const AdminAttendancePage: React.FC = () => {
  ...
  return (
    <DashboardLayout title="Attendance Management" role="admin">
      {/* Dashboard Content */}
      <div className="space-y-6">
        {/* Stats Cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-lg shadow-md p-6 flex items-center animate-fade-in">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 flex items-center animate-fade-in" style={{ animationDelay: '0.1s' }}>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 flex items-center animate-fade-in" style={{ animationDelay: '0.2s' }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Active Session Card */}
          <div className="bg-white rounded-lg shadow-md overflow-hidden animate-fade-in" style={{ animationDelay: '0.3s' }}>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="text-center">
                    ...
                    <button 
                      ...
                      className="bg-primary-100 text-primary-800 px-4 py-2 rounded-md text-sm font-medium hover:bg-primary-200 transition-colors"
                    >
                      Regenerate QR Code
                    </button>
                  </div>
        ...
        {/* Attendance Table */}
        <div className="bg-white rounded-lg shadow-md overflow-hidden animate-fade-in" style={{ animationDelay: '0.5s' }}>
          <div className="bg-primary-600 px-6 py-4">
